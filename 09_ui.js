/* ════════════════════════════════════════════════════════════════
   AgriSmart — 09 — UI — Notifications, Navigation Mobile, Horloge
   showNotif(), buildMobileNav(), updateMobileNav(), toggleMobileSidebar()
   Guide supprimé — Chatbot IA amélioré (Anthropic API)
   Fichier : 09_ui.js
════════════════════════════════════════════════════════════════ */
...
const MOB_NAV_ITEMS = {
  ...
  agriculteur: [{id:'dashboard',ico:'🏠',lbl:'Accueil'},{id:'rf',ico:'🌾',lbl:'Culture'},{id:'lstm',ico:'🌧️',lbl:'Météo'},{id:'history',ico:'📜',lbl:'Mesures'}],
  technicien:  [{id:'dashboard',ico:'🏠',lbl:'Accueil'},{id:'iot',ico:'📡',lbl:'Capteurs'},{id:'lstm',ico:'📈',lbl:'IA'},{id:'history',ico:'📜',lbl:'Données'}],
};
