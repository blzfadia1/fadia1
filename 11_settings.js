...
,
    cnnChooseCulture: '-- Choisir une culture --',
    cnnAnalyse: '⚡ Analyser',
    cnnVueSat: '🛰️ Vue Satellite',
    cnnGPSReel: '🛰️ GPS réel',
    cnnResultats: 'Résultats CNN',
    cnnTFPret: '🧠 TF.js — prêt',
    cnnDonnees: '📡 Données',
    cnnCharger: '🔄 Charger',
    lstmAbsent: 'absent',
    lstmBasePrev: 'Base prévision',
    lstmSeuilCrit: 'Seuil: 35%',
    lstmCapteurSol: '← capteur sol',
    lstmEstimPluie: 'Estimation pluie',
    lstmSondePH: '← sonde pH',
    lstmDHT11: '← DHT11',
    humAir: 'Humidité Air',
    tempLabel: 'Température',
    loraDesc: 'Le LoRaWAN permet à vos capteurs ESP32 de transmettre des données sur 10-15 km avec une consommation ultra-faible.',
    loraGW: '2. Gateway LoRaWAN',
    loraGWDesc: 'Reçoit les trames LoRa sur 8 canaux simultanés. Décode et transmet via Ethernet/4G au serveur cloud.'
,
    cnnBtnSat: '🛰️ Satellite',
    cnnBtnHybrid: '🛰️+Labels',
    cnnBtnRoad: '🗺️ Plan',
    cnnBtnTerrain: '🏔️ Terrain',
    cnnBtnCenter: '🎯 Centrer',
    cnnBtnFull: '⛶ Plein écran',
    cnnLegOpt: 'Optimal ≥72%',
    cnnLegAcc: 'Acceptable 48–71%',
    cnnLegInc: 'Incompatible <48%',
    cnnLegNone: 'Non analysé',
    cnnRunLbl: 'Analyser',
    cnnIdleMsg: 'Choisissez une culture et lancez l'analyse',
    cnnHeading: '🛰️ Analyse CNN — Satellite GPS',
    cnnGPSBadge: '🛰️ GPS réel'
,
    cnnLegNone: 'Non analysé',
    iotLoRaSig: 'Signal LoRa moyen'
,
    lstmPrecision: 'Précision LSTM',
    lstmCeMois: '↑ +2.1% ce mois',
    lstmHorizon: 'Horizon de prévision',
    lstmFenetre: 'Fenêtre d'entrée',
    lstmErreur: 'Erreur MAE',
    lstmAmeliore: '↓ Amélioré',
    lstmLegend: 'Gris = 7 jours passés · Violet/Orange = 7 jours prévus · Jaune pointillé = seuil critique 35% (irriguer)',
    iotNoeudsActifs: 'Nœuds ESP32 actifs',
    iotEnLigne: '100% en ligne',
    iotSignal: 'Signal LoRa moyen',
    iotBatterie: 'Autonomie batterie',
    iotIntervalle: 'Intervalle envoi',
    iotColNoeud: 'Nœud',
    iotColZone: 'Zone',
    iotColRSSI: 'RSSI',
    iotColSF: 'SF',
    ...
    iotColAction: 'Action',
    iotMesure: '💾 Mesure',
    iotEnLigneTxt: '✓ En ligne',
    iotHorsLigneTxt: '✗ Hors ligne',
    cnnHumAir: 'Hum. air',
    cnnTemp: 'Température',
    cnnDonneesBtn: '🔄 Données',
    cnnCultureTournousole: 'Tournesol',
    cnnCultureRiz: 'Riz',
    cnnCultureBle: 'Blé',
    cnnCultureMais: 'Maïs',
    cnnCultureTomate: 'Tomate',
    cnnCultureSoja: 'Soja',
    cnnCultureCafe: 'Café',
    cnnCultureCotton: 'Coton',
    cnnCulturePomme: 'Pomme de terre',
    cnnCultureMangue: 'Mangue',
    cnnCultureRaisin: 'Raisin',
    cnnCulturePois: 'Pois chiche',
    lstmCharger: '🔄 Charger'
},
...
,
    cnnChooseCulture: '-- اختر ثقافة --',
    cnnAnalyse: '⚡ تحليل',
    cnnVueSat: '🛰️ صورة الأقمار الصناعية',
    cnnGPSReel: '🛰️ GPS حقيقي',
    cnnResultats: 'نتائج CNN',
    cnnTFPret: '🧠 TF.js — جاهز',
    cnnDonnees: '📡 بيانات',
    cnnCharger: '🔄 تحميل',
    lstmAbsent: 'غائب',
    lstmBasePrev: 'أساس التنبؤ',
    lstmSeuilCrit: 'العتبة: 35%',
    lstmCapteurSol: '← مستشعر التربة',
    lstmEstimPluie: 'تقدير الأمطار',
    lstmSondePH: '← مسبار pH',
    lstmDHT11: '← DHT11',
    humAir: 'رطوبة الهواء',
    tempLabel: 'درجة الحرارة',
    loraDesc: 'يتيح LoRaWAN لمستشعرات ESP32 نقل البيانات على مسافة 10-15 كم باستهلاك طاقة منخفض جداً.',
    loraGW: '2. Gateway LoRaWAN',
    loraGWDesc: 'يستقبل إطارات LoRa على 8 قنوات. يفك الترميز ويرسل عبر Ethernet/4G إلى خادم السحابة.'
,
    cnnBtnSat: '🛰️ أقمار صناعية',
    cnnBtnHybrid: '🛰️+تسميات',
    cnnBtnRoad: '🗺️ خريطة',
    cnnBtnTerrain: '🏔️ تضاريس',
    cnnBtnCenter: '🎯 توسيط',
    cnnBtnFull: '⛶ ملء الشاشة',
    cnnLegOpt: 'مثالي ≥72%',
    cnnLegAcc: 'مقبول 48–71%',
    cnnLegInc: 'غير متوافق <48%',
    cnnLegNone: 'لم يُحلَّل',
    cnnRunLbl: 'تحليل',
    cnnIdleMsg: 'اختر ثقافة وابدأ التحليل',
    cnnHeading: '🛰️ تحليل CNN — GPS الفضائي',
    cnnGPSBadge: '🛰️ GPS حقيقي'
,
    cnnLegNone: 'لم يُحلَّل',
    iotLoRaSig: 'إشارة LoRa المتوسطة'
,
    lstmPrecision: 'دقة LSTM',
    lstmCeMois: '↑ +2.1% هذا الشهر',
    lstmHorizon: 'أفق التنبؤ',
    lstmFenetre: 'نافذة الإدخال',
    lstmErreur: 'خطأ MAE',
    lstmAmeliore: '↓ محسّن',
    lstmLegend: 'رمادي = 7 أيام ماضية · بنفسجي/برتقالي = 7 أيام قادمة · أصفر منقط = عتبة حرجة 35% (ري)',
    iotNoeudsActifs: 'عقد ESP32 نشطة',
    iotEnLigne: '100% متصل',
    iotSignal: 'إشارة LoRa المتوسطة',
    iotBatterie: 'عمر البطارية',
    iotIntervalle: 'فترة الإرسال',
    iotColNoeud: 'عقدة',
    iotColZone: 'منطقة',
    iotColRSSI: 'RSSI',
    iotColSF: 'SF',
    ...
    iotMesure: '💾 قياس',
    iotEnLigneTxt: '✓ متصل',
    iotHorsLigneTxt: '✗ غير متصل',
    cnnHumAir: 'رطوبة الهواء',
    cnnTemp: 'درجة الحرارة',
    cnnDonneesBtn: '🔄 بيانات',
    cnnCultureTournousole: 'عباد الشمس',
    cnnCultureRiz: 'أرز',
    cnnCultureBle: 'قمح',
    cnnCultureMais: 'ذرة',
    cnnCultureTomate: 'طماطم',
    cnnCultureSoja: 'فول الصويا',
    cnnCultureCafe: 'قهوة',
    cnnCultureCotton: 'قطن',
    cnnCulturePomme: 'بطاطس',
    cnnCultureMangue: 'مانجو',
    cnnCultureRaisin: 'عنب',
    cnnCulturePois: 'حمص',
    lstmCharger: '🔄 تحميل'
},
...
,
    cnnChooseCulture: '-- Choose a crop --',
    cnnAnalyse: '⚡ Analyze',
    cnnVueSat: '🛰️ Satellite View',
    cnnGPSReel: '🛰️ Real GPS',
    cnnResultats: 'CNN Results',
    cnnTFPret: '🧠 TF.js — Ready',
    cnnDonnees: '📡 Data',
    cnnCharger: '🔄 Load',
    lstmAbsent: 'absent',
    lstmBasePrev: 'Forecast base',
    lstmSeuilCrit: 'Threshold: 35%',
    lstmCapteurSol: '← soil sensor',
    lstmEstimPluie: 'Rain estimate',
    lstmSondePH: '← pH probe',
    lstmDHT11: '← DHT11',
    humAir: 'Air Humidity',
    tempLabel: 'Temperature',
    loraDesc: 'LoRaWAN lets ESP32 sensors transmit data up to 10-15 km with ultra-low power consumption.',
    loraGW: '2. LoRaWAN Gateway',
    loraGWDesc: 'Receives LoRa frames on 8 simultaneous channels. Decodes and forwards via Ethernet/4G to cloud server.'
,
    cnnBtnSat: '🛰️ Satellite',
    cnnBtnHybrid: '🛰️+Labels',
    cnnBtnRoad: '🗺️ Map',
    cnnBtnTerrain: '🏔️ Terrain',
    cnnBtnCenter: '🎯 Center',
    cnnBtnFull: '⛶ Fullscreen',
    cnnLegOpt: 'Optimal ≥72%',
    cnnLegAcc: 'Acceptable 48–71%',
    cnnLegInc: 'Incompatible <48%',
    cnnLegNone: 'Not analyzed',
    cnnRunLbl: 'Analyze',
    cnnIdleMsg: 'Choose a crop and start analysis',
    cnnHeading: '🛰️ CNN Analysis — GPS Satellite',
    cnnGPSBadge: '🛰️ Real GPS'
,
    cnnLegNone: 'Not analyzed',
    iotLoRaSig: 'Average LoRa Signal'
,
    adminStatTech: 'Technicians',
    alertNoneSub: 'All sensors are working normally.',
    archL1Desc: 'ESP32 collects T°, pH, humidity, NPK every 10 seconds.',
    archL2Desc: 'Long-range transmission (10km) via LoRaWAN 868MHz protocol.',
    archL3Desc: 'Firebase Realtime Database, real-time processing, 30-day history.',
    archL4Desc: '100 decision trees recommend the optimal crop (98% accuracy).',
    archL5Desc: 'LSTM network predicts irrigation needs over 7 days (92% accuracy).',
    archL6Desc: 'Responsive web interface for farmers, technicians and admins.',
    cardImportance: 'Sensor Importance',
    cardJournal: 'System Log',
    cardReco: 'Recommendation',
    cardTimeline: 'Recent Activity',
    confirmDeleteSub: 'This action cannot be undone.',
    pageAdmin: 'Administration',
    pageIoT: 'IoT · ESP32 · LoRaWAN',
    pageRF: 'Random Forest — Crop Recommendation'
,
    lstmPrecision: 'LSTM Accuracy',
    lstmCeMois: '↑ +2.1% this month',
    lstmHorizon: 'Forecast horizon',
    lstmFenetre: 'Input window',
    lstmErreur: 'MAE Error',
    lstmAmeliore: '↓ Improved',
    lstmLegend: 'Gray = past 7 days · Purple/Orange = next 7 days · Yellow dashed = critical 35% threshold (irrigate)',
    iotNoeudsActifs: 'Active ESP32 Nodes',
    iotEnLigne: '100% online',
    iotSignal: 'Average LoRa Signal',
    iotBatterie: 'Battery life',
    iotIntervalle: 'Send interval',
    iotColNoeud: 'Node',
    iotColZone: 'Zone',
    iotColRSSI: 'RSSI',
    iotColSF: 'SF',
    ...
    iotColAction: 'Action',
    iotMesure: '💾 Measure',
    iotEnLigneTxt: '✓ Online',
    iotHorsLigneTxt: '✗ Offline',
    cnnHumAir: 'Air Humidity',
    cnnTemp: 'Temperature',
    cnnDonneesBtn: '🔄 Data',
    cnnCultureTournousole: 'Sunflower',
    cnnCultureRiz: 'Rice',
    cnnCultureBle: 'Wheat',
    cnnCultureMais: 'Corn',
    cnnCultureTomate: 'Tomato',
    cnnCultureSoja: 'Soybean',
    cnnCultureCafe: 'Coffee',
    cnnCultureCotton: 'Cotton',
    cnnCulturePomme: 'Potato',
    cnnCultureMangue: 'Mango',
    cnnCultureRaisin: 'Grape',
    cnnCulturePois: 'Chickpea',
    lstmCharger: '🔄 Load'
},
};
...
function setLang(lang) {
  if (!LANG[lang]) return;
  _lang = lang;
  // Synchroniser les DEUX clés localStorage pour éviter les conflits
  try {
    localStorage.setItem('agrismart_lang', lang);
    localStorage.setItem('as_lang', lang);  // ← clé utilisée par le HTML
  } catch(e) {}
  applyLang();
...
(function() {
  try {
    const s1 = localStorage.getItem('agrismart_lang');
    const s2 = localStorage.getItem('as_lang');
    const saved = s1 || s2;  // prendre n'importe laquelle des deux
    if (saved && LANG[saved]) _lang = saved;
  } catch(e) {}
